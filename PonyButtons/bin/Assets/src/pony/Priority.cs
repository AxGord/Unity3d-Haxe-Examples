...
namespace pony
{
	public  class Priority<T> : global::haxe.lang.HxObject, global::pony.Priority 
	{
		...
		public static   void __hx_ctor_pony_Priority<T_c>(global::pony.Priority<T_c> __temp_me82, global::Array<T_c> data)
		{
			unchecked 
			{
				#line 80 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
				__temp_me82.@double = false;
				__temp_me82.clear();
				if (( data != default(global::Array<T_c>) )) 
				{
					#line 82 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					__temp_me82.data = data;
				}
		...
		public virtual   object pony_Priority_cast<T_c>()
		{
			unchecked 
			{
				...
				{
					#line 37 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					object __temp_iterator167 = global::Reflect.fields(this).iterator();
					#line 37 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator167, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 37 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						string field = global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.callField(__temp_iterator167, "next", 1224901875, default(global::Array)));
						#line 37 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						switch (field)
						{
							default:
		...
		public virtual   global::pony.Priority<T> addElement(T e, global::haxe.lang.Null<int> priority)
		{
			unchecked 
			{
				...
				int __temp_priority76 = ( (global::haxe.lang.Runtime.eq((priority).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (0) )) : (priority.@value) );
				bool __temp_boolv355 =  ! (this.@double) ;
				#line 91 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
				bool __temp_boolv354 = false;
				#line 91 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
				if (__temp_boolv355) 
				{
					#line 91 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					{
						...
						#line 91 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						__temp_boolv354 = global::Lambda.exists<T>(this.data, new global::pony.Priority_addElement_91__Fun<T>(((global::Array<T>) (global::Array<object>.__hx_cast<T>(((global::Array) (element) ))) )));
					}
					
				}
				
				#line 91 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
				bool __temp_stmt353 = ( __temp_boolv355 && __temp_boolv354 );
				#line 91 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
				if (__temp_stmt353) 
				{
					#line 91 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
				...
				if (this.hash.exists(__temp_priority76)) 
				{
					#line 92 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					s = this.hash.@get(__temp_priority76).@value;
				}
				 else 
				{
					#line 92 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
				...
				int c = 0;
				{
					...
					object __temp_iterator168 = this.hash.keys();
					#line 94 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator168, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 94 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						int k = ((int) (global::haxe.lang.Runtime.toInt(global::haxe.lang.Runtime.callField(__temp_iterator168, "next", 1224901875, default(global::Array)))) );
						if (( k < __temp_priority76 )) 
						{
				...
				this.hash.@set(__temp_priority76, ( s + 1 ));
				return this;
			}
			#line default
		}
		...
		public virtual   global::pony.Priority<T> addArray(global::Array<T> a, global::haxe.lang.Null<int> priority)
		{
			unchecked 
			{
				...
				int __temp_priority77 = ( (global::haxe.lang.Runtime.eq((priority).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (0) )) : (priority.@value) );
				{
					...
					while (( _g < a.length ))
					{
						...
						#line 110 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						 ++ _g;
						this.addElement(e, new global::haxe.lang.Null<int>(__temp_priority77, true));
					}
		...
		public virtual   object iterator()
		{
			unchecked 
			{
				...
				{
					global::haxe.lang.Function __temp_odecl356 = new global::pony.Priority_iterator_127__Fun<T>(((global::Array<object>) (global::Array<object>.__hx_cast<object>(((global::Array) (_g) ))) ), ((global::Array<int>) (global::Array<object>.__hx_cast<int>(((global::Array) (n) ))) ));
					#line 136 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					global::haxe.lang.Function __temp_odecl357 = new global::pony.Priority_iterator_136__Fun<T>(((global::Array<object>) (global::Array<object>.__hx_cast<object>(((global::Array) (_g) ))) ), ((global::Array<int>) (global::Array<object>.__hx_cast<int>(((global::Array) (n) ))) ));
					#line 126 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					return new global::haxe.lang.DynamicObject(new global::Array<int>(new int[]{407283053, 1224901875}), new global::Array<object>(new object[]{__temp_odecl356, __temp_odecl357}), new global::Array<int>(new int[]{}), new global::Array<double>(new double[]{}));
				}
				...
				#line 156 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
				{
					...
					while (( _g < a.length ))
					{
						...
						#line 156 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						 ++ _g;
						#line 156 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						bool __temp_stmt358 = default(bool);
						#line 156 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						{
							#line 156 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
							global::Array<T> element = new global::Array<T>(new T[]{e});
							#line 156 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
							__temp_stmt358 = global::Lambda.exists<T>(this.data, new global::pony.Priority_existsArray_156__Fun<T>(((global::Array<T>) (global::Array<object>.__hx_cast<T>(((global::Array) (element) ))) )));
						}
		...
		public virtual   T search(global::haxe.lang.Function f)
		{
			unchecked 
			{
				...
				global::Lambda.exists<T>(this.data, new global::pony.Priority_search_165__Fun<T>(((global::Array<object>) (global::Array<object>.__hx_cast<object>(((global::Array) (f1) ))) ), ((global::Array<T>) (global::Array<object>.__hx_cast<T>(((global::Array) (s) ))) )));
		...
		public virtual   bool removeElement(T e)
		{
			unchecked 
			{
				...
				global::Array<int> a = new global::Array<int>(new int[]{});
				{
					...
					object __temp_iterator169 = this.hash.keys();
					#line 185 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator169, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 185 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						int k1 = ((int) (global::haxe.lang.Runtime.toInt(global::haxe.lang.Runtime.callField(__temp_iterator169, "next", 1224901875, default(global::Array)))) );
						a.push(k1);
					}
		...
		public virtual   void repriority(global::haxe.lang.Null<int> priority)
		{
			unchecked 
			{
				...
				int __temp_priority78 = ( (global::haxe.lang.Runtime.eq((priority).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (0) )) : (priority.@value) );
				this.hash = new global::haxe.ds.IntMap<int>();
				this.hash.@set(__temp_priority78, this.data.length);
			}
			#line default
		}
		...
		public virtual   global::pony.Priority<T> changeElement(T e, global::haxe.lang.Null<int> priority)
		{
			unchecked 
			{
				...
				if (this.removeElement(e)) 
				{
					...
					this.addElement(e, new global::haxe.lang.Null<int>(__temp_priority79, true));
				}
				 else 
				{
		...
		public virtual   global::pony.Priority<T> changeFunction(global::haxe.lang.Function f, global::haxe.lang.Null<int> priority)
		{
			unchecked 
			{
				...
				T e = this.search(f);
				return this.changeElement(e, new global::haxe.lang.Null<int>(__temp_priority80, true));
			}
			#line default
		}
				...
				int __temp_priority81 = ( (global::haxe.lang.Runtime.eq((priority).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (0) )) : (priority.@value) );
				{
					...
					while (( _g < a.length ))
					{
						...
						#line 233 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						 ++ _g;
						#line 233 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						this.changeElement(e, new global::haxe.lang.Null<int>(__temp_priority81, true));
					}
		...
		public   void reloop(T e)
		{
			unchecked 
			{
				...
				{
					#line 275 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					object __temp_expr359 = default(object);
				}
		...
		public virtual   int _get_min()
		{
			unchecked 
			{
				...
				global::haxe.lang.Null<int> n = default(global::haxe.lang.Null<int>);
				{
					...
					object __temp_iterator170 = this.hash.keys();
					#line 296 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator170, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 296 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						int k = ((int) (global::haxe.lang.Runtime.toInt(global::haxe.lang.Runtime.callField(__temp_iterator170, "next", 1224901875, default(global::Array)))) );
		...
		public virtual   int _get_max()
		{
			unchecked 
			{
				...
				global::haxe.lang.Null<int> n = default(global::haxe.lang.Null<int>);
				{
					...
					object __temp_iterator171 = this.hash.keys();
					#line 307 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator171, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 307 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						int k = ((int) (global::haxe.lang.Runtime.toInt(global::haxe.lang.Runtime.callField(__temp_iterator171, "next", 1224901875, default(global::Array)))) );
						if (( global::haxe.lang.Runtime.eq((n).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic()) || ( k > n.@value ) )) 
						{
							n = new global::haxe.lang.Null<int>(new global::haxe.lang.Null<int>(k, true).@value, true);
						}
			...
			unchecked 
			{
				...
				switch (hash)
				{
					case 1202522710:
					{
						...
						{
							#line 37 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
							__temp_stmt360 = this.last;
						}
						
						#line 37 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						return ((double) (global::haxe.lang.Runtime.toDouble(((object) (__temp_stmt360) ))) );
					}
					...
					case 10319920:
					{
						...
						{
							#line 37 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
							__temp_stmt361 = this.first;
						}
						
						#line 37 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Priority.hx"
						return ((double) (global::haxe.lang.Runtime.toDouble(((object) (__temp_stmt361) ))) );
					}
...
namespace pony
{
	...
	{
		public    Priority_search_165__Fun(global::Array<object> f1, global::Array<T> s) : base(1, 0)
		{
			unchecked 
			{
