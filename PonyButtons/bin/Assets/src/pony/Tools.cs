...
namespace pony
{
	public  class Tools : global::haxe.lang.HxObject 
	{
		...
		public static   void __hx_ctor_pony_Tools(global::pony.Tools __temp_me94)
		{
			unchecked 
			{
				#line 43 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
		...
		public static   bool equal(object a, object b, global::haxe.lang.Null<int> maxDepth)
		{
			unchecked 
			{
				...
				int __temp_maxDepth91 = ( (global::haxe.lang.Runtime.eq((maxDepth).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (1) )) : (maxDepth.@value) );
				...
				switch (global::Type.enumIndex(type))
				{
					...
					case 5:
					{
						...
						catch (global::System.Exception __temp_catchallException430)
						{
							#line 71 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
							object __temp_catchall431 = __temp_catchallException430;
							#line 71 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
							if (( __temp_catchall431 is global::haxe.lang.HaxeException )) 
							{
								#line 71 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
								__temp_catchall431 = ((global::haxe.lang.HaxeException) (__temp_catchallException430) ).obj;
							}
							
							#line 71 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
							{
								#line 71 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
								object _ = __temp_catchall431;
								#line 71 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
								return false;
							}
						...
						#line 73 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						{
							...
							
							{
								...
								while (( _g1 < _g ))
								{
									#line 82 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
									int i = _g1++;
									if ( ! (global::pony.Tools.equal(a1[i], b1[i], new global::haxe.lang.Null<int>(( __temp_maxDepth91 - 1 ), true))) ) 
									{
						...
						if (global::haxe.lang.Runtime.refEq(t1, typeof(global::Array))) 
						{
							...
							
							{
								...
								while (( _g11 < _g2 ))
								{
									#line 94 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
									int i1 = _g11++;
									if ( ! (global::pony.Tools.equal(((object) (global::haxe.lang.Runtime.callField(a, "__get", 1915412854, new global::Array<object>(new object[]{i1}))) ), ((object) (global::haxe.lang.Runtime.callField(b, "__get", 1915412854, new global::Array<object>(new object[]{i1}))) ), new global::haxe.lang.Null<int>(( __temp_maxDepth91 - 1 ), true))) ) 
									{
				...
				if (( fields.length == global::Reflect.fields(b).length )) 
				{
					...
					
					{
						...
						while (( _g4 < fields.length ))
						{
							...
							#line 113 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
							 ++ _g4;
							if ((  ! (global::Reflect.hasField(b, f))  ||  ! (global::pony.Tools.equal(global::Reflect.field(a, f), global::Reflect.field(b, f), new global::haxe.lang.Null<int>(( __temp_maxDepth91 - 1 ), true)))  )) 
							{
								return false;
							}
		...
		public static   int superIndexOf<T>(object it, T v, global::haxe.lang.Null<int> maxDepth)
		{
			unchecked 
			{
				...
				int __temp_maxDepth92 = ( (global::haxe.lang.Runtime.eq((maxDepth).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (1) )) : (maxDepth.@value) );
				int i = 0;
				{
					#line 123 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					object __temp_iterator180 = ((object) (global::haxe.lang.Runtime.callField(it, "iterator", 328878574, default(global::Array))) );
					#line 123 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator180, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 123 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						T e = global::haxe.lang.Runtime.genericCast<T>(global::haxe.lang.Runtime.callField(__temp_iterator180, "next", 1224901875, default(global::Array)));
						if (global::pony.Tools.equal(e, v, new global::haxe.lang.Null<int>(__temp_maxDepth92, true))) 
						{
		...
		public static   int superMultyIndexOf<T>(object it, global::Array<T> av, global::haxe.lang.Null<int> maxDepth)
		{
			unchecked 
			{
				...
				int __temp_maxDepth93 = ( (global::haxe.lang.Runtime.eq((maxDepth).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (1) )) : (maxDepth.@value) );
				int i = 0;
				{
					#line 132 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					object __temp_iterator181 = ((object) (global::haxe.lang.Runtime.callField(it, "iterator", 328878574, default(global::Array))) );
					#line 132 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator181, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 132 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						T e = global::haxe.lang.Runtime.genericCast<T>(global::haxe.lang.Runtime.callField(__temp_iterator181, "next", 1224901875, default(global::Array)));
						{
							...
							while (( _g < av.length ))
							{
								...
								#line 133 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
								 ++ _g;
								#line 133 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
								if (global::pony.Tools.equal(e, v, new global::haxe.lang.Null<int>(__temp_maxDepth93, true))) 
								{
									#line 133 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
									return i;
								}
		...
		public static   int multyIndexOf<T>(object it, global::Array<T> av)
		{
			unchecked 
			{
				...
				int i = 0;
				{
					...
					object __temp_iterator182 = ((object) (global::haxe.lang.Runtime.callField(it, "iterator", 328878574, default(global::Array))) );
					#line 141 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator182, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 141 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						T e = global::haxe.lang.Runtime.genericCast<T>(global::haxe.lang.Runtime.callField(__temp_iterator182, "next", 1224901875, default(global::Array)));
						{
		...
		public static   global::haxe.io.BytesInput cut(global::haxe.io.BytesInput inp)
		{
			unchecked 
			{
				...
				while (true)
				{
					...
					catch (global::System.Exception __temp_catchallException432)
					{
						#line 165 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						object __temp_catchall433 = __temp_catchallException432;
						#line 165 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						if (( __temp_catchall433 is global::haxe.lang.HaxeException )) 
						{
							#line 165 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
							__temp_catchall433 = ((global::haxe.lang.HaxeException) (__temp_catchallException432) ).obj;
						}
						
						#line 165 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						{
							#line 165 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
							object _ = __temp_catchall433;
							#line 165 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
							break;
						}
...
namespace pony
{
	public  class ArrayTools : global::haxe.lang.HxObject 
	{
		...
		public static   void __hx_ctor_pony_ArrayTools(global::pony.ArrayTools __temp_me95)
		{
			unchecked 
			{
				#line 202 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
		...
		public static   bool thereIs<T>(object a, global::Array<T> b)
		{
			unchecked 
			{
				...
				{
					#line 205 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					object __temp_iterator183 = ((object) (global::haxe.lang.Runtime.callField(a, "iterator", 328878574, default(global::Array))) );
					#line 205 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator183, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 205 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						global::Array<T> e = ((global::Array<T>) (global::Array<object>.__hx_cast<T>(((global::Array) (global::haxe.lang.Runtime.callField(__temp_iterator183, "next", 1224901875, default(global::Array))) ))) );
						#line 205 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
...
namespace pony
{
	public  class FloatTools : global::haxe.lang.HxObject 
	{
		...
		public static   void __hx_ctor_pony_FloatTools(global::pony.FloatTools __temp_me98)
		{
			unchecked 
			{
				#line 217 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
		...
		public static   string _toFixed(double v, int n, global::haxe.lang.Null<int> begin, string d, string beginS, string endS)
		{
			unchecked 
			{
				...
				#line 233 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
				int __temp_begin96 = ( (global::haxe.lang.Runtime.eq((begin).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (0) )) : (begin.@value) );
				if (( __temp_begin96 != 0 )) 
				{
					...
					int d1 = ( __temp_begin96 - global::haxe.lang.Runtime.toString(a[0]).Length );
		...
		public static   bool approximately(double a, double b, global::haxe.lang.Null<double> range)
		{
			unchecked 
			{
				...
				double __temp_range97 = ( (global::haxe.lang.Runtime.eq((range).toDynamic(), (default(global::haxe.lang.Null<double>)).toDynamic())) ? (((double) (1) )) : (range.@value) );
				#line 254 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
				return ( ( ( b - __temp_range97 ) <= a ) && ( a <= ( b + __temp_range97 ) ) );
			}
			#line default
		}
...
namespace pony
{
	public  class StringTls : global::haxe.lang.HxObject 
	{
		...
		public static   void __hx_ctor_pony_StringTls(global::pony.StringTls __temp_me99)
		{
			unchecked 
			{
				#line 284 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
		...
		public static   bool isTrue(string s)
		{
			unchecked 
			{
				...
				string __temp_stmt435 = default(string);
				#line 292 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
				{
					#line 292 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					string s1 = s.ToLower();
					#line 292 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					__temp_stmt435 = s1.Trim();
				}
				
				#line 292 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
				return string.Equals(__temp_stmt435, "true");
			}
			#line default
		}
...
namespace pony
{
	public  class XmlTools : global::haxe.lang.HxObject 
	{
		...
		public static   void __hx_ctor_pony_XmlTools(global::pony.XmlTools __temp_me100)
		{
			unchecked 
			{
				#line 318 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
		...
		public static   bool isTrue(global::haxe.xml.Fast x, string name)
		{
			unchecked 
			{
				...
				bool __temp_boolv438 = x.has.resolve(name);
				#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
				bool __temp_boolv437 = false;
				#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
				if (__temp_boolv438) 
				{
					#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
					{
						...
						#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						string __temp_stmt439 = default(string);
						#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						{
							#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
							string s1 = s.ToLower();
							#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
							__temp_stmt439 = s1.Trim();
						}
						
						#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
						__temp_boolv437 = string.Equals(__temp_stmt439, "true");
					}
					
				}
				
				#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
				bool __temp_stmt436 = ( __temp_boolv438 && __temp_boolv437 );
				#line 319 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/Tools.hx"
				return __temp_stmt436;
			}
			#line default
		}
