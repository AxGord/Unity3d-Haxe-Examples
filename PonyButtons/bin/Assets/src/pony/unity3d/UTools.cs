...
namespace pony.unity3d
{
	public  class UTools : global::haxe.lang.HxObject 
	{
		...
		public static   void __hx_ctor_pony_unity3d_UTools(global::pony.unity3d.UTools __temp_me127)
		{
			unchecked 
			{
				#line 40 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/unity3d/UTools.hx"
		...
		public static   bool init(string key, string camera, global::haxe.lang.Null<int> defWidth, global::haxe.lang.Null<int> defHeight, global::haxe.lang.Null<bool> fs)
		{
			unchecked 
			{
				...
				bool __temp_fs126 = ( (global::haxe.lang.Runtime.eq((fs).toDynamic(), (default(global::haxe.lang.Null<bool>)).toDynamic())) ? (((bool) (true) )) : (fs.@value) );
				#line 43 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/unity3d/UTools.hx"
				int __temp_defHeight125 = ( (global::haxe.lang.Runtime.eq((defHeight).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (600) )) : (defHeight.@value) );
				#line 43 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/unity3d/UTools.hx"
				int __temp_defWidth124 = ( (global::haxe.lang.Runtime.eq((defWidth).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (800) )) : (defWidth.@value) );
				#line 43 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/unity3d/UTools.hx"
				...
				{
					global::UnityEngine.Screen.SetResolution(cfg_width.@value, cfg_height.@value, ((bool) (__temp_fs126) ));
				}
				 else 
				{
					#line 55 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/unity3d/UTools.hx"
					global::UnityEngine.Screen.SetResolution(((int) (__temp_defWidth124) ), ((int) (__temp_defHeight125) ), ((bool) (false) ));
				}
