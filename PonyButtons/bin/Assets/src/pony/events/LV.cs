...
namespace pony.events
{
	public  class LV<T> : global::pony.events.Signal, global::pony.events.LV 
	{
		...
		public static   void __hx_ctor_pony_events_LV<T_c>(global::pony.events.LV<T_c> __temp_me103, T_c @value)
		{
			unchecked 
			{
				#line 39 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
				global::pony.events.Signal.__hx_ctor_pony_events_Signal(__temp_me103, default(object));
				{
					#line 40 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
					if (( ! (global::haxe.lang.Runtime.eq(@value, __temp_me103.@value)) )) 
					{
						#line 40 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
						...
						{
							#line 40 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
							__temp_me103.dispatchEvent(new global::pony.events.Event(((global::Array) (new global::Array<object>(new object[]{@value})) ), ((object) (__temp_me103.target) ), ((global::pony.events.Event) (default(global::pony.events.Event)) )));
							#line 40 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
							global::pony.events.LV<T_c> __temp_expr441 = __temp_me103;
						}
						
					}
					
					#line 40 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
					T_c __temp_expr442 = @value;
				}
		...
		public virtual   object pony_events_LV_cast<T_c>()
		{
			unchecked 
			{
				...
				{
					#line 34 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
					object __temp_iterator184 = global::Reflect.fields(this).iterator();
					#line 34 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
					while (((bool) (global::haxe.lang.Runtime.callField(__temp_iterator184, "hasNext", 407283053, default(global::Array))) ))
					{
						#line 34 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
						string field = global::haxe.lang.Runtime.toString(global::haxe.lang.Runtime.callField(__temp_iterator184, "next", 1224901875, default(global::Array)));
						#line 34 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
						switch (field)
						{
							default:
			...
			unchecked 
			{
				...
				if (( ! (global::haxe.lang.Runtime.eq(v, this.@value)) )) 
				{
					this.@value = v;
					{
						...
						#line 46 "C:\\HaxeToolkit\\haxe\\lib\\pony/git/pony/events/LV.hx"
						global::pony.events.LV<T> __temp_expr440 = this;
					}
